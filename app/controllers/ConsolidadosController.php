    ...
    private function generarHTMLPDFConsolidado(array $comunidad, int $anio, array $matriz, array $totales, array $meses): string {
        ...
        foreach ($meses as $mes) {
            if (isset($totales['totales'][$mes])) {
                ...
                $totalsHTML .= '<div style="display: inline-block; width: 20px; height: 20px; background-color: #28a745; color: white; text-align: center; line-height: 20px; font-weight: bold; font-size: 12px;">V</div> <span style="color: #155724;">$' . number_format($mesTotal['pagado'], 0, ',', '.') . '</span><br>';
...
<head>
    ...
    <style>
        ...
        .badge-ok { display: inline-block; width: 20px; height: 20px; background: #28a745; color: white; text-align: center; line-height: 20px; font-weight: bold; font-size: 12px; }
...
<body>
    ...
    <div class="legend">
        <div class="legend-item"><span class="badge-ok">V</span> Pagado</div>
